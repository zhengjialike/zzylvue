<template>
  ...
  <div>
    ...
    >
      ...
      <el-table-column prop="billNo" label="单据编号" min-width="125" align="center" show-overflow-tooltip />
      <el-table-column prop="elderName" label="老人姓名" min-width="75" align="center" show-overflow-tooltip />
      <el-table-column prop="idCard" label="身份证号" min-width="135" align="center" show-overflow-tooltip />
      <el-table-column prop="bedNo" label="入住床位" min-width="75" align="center" show-overflow-tooltip />
      <el-table-column prop="applicant" label="创建人" min-width="75" align="center" show-overflow-tooltip />
      <el-table-column prop="createTime" label="创建时间" min-width="120" align="center" show-overflow-tooltip />
      <el-table-column prop="checkInDate" label="入住日期" min-width="85" align="center" show-overflow-tooltip />
